...
import model from "../../../assets/home/journalmodelblue.png";
  ...
  const [Journal_Data] = useState([
    {
      ...
      j_body:
        "Lorem ipsum dolor sit amet consectetur. Sem sodales vulputate non porta ante mauris fringilla non at. Ipsum id proin lectus eget venenatis facilisis adipiscing consectetur. Velit feugiat sit a egestas. Nunc parturient id pharetra porttitor aenean leo sit praesent.",
      ...
      <div className="width-limiter">
        <div className="Section2JournalContainer">
          {Journal_Data.map((journal, index) => {
            return (
              <Link
                to={"/la-isla-webpage/journal/seo"}
                key={index}
                className="journal-format"
              >
                <div>
                  <img src={journal.j_img} alt="" />
                  <p className="Section2JournalTitle">
                    <b>{journal.j_title}</b>
                  </p>
                  <hr />
        ...
        <div className="Section2JournalNextPrevHolder">
          <div className="Section2JournalNextPrev">
            <button className="Section2JournalcontactBtn">
              <img src={prev} alt="" />
            </button>
            <div className="Section2JournalNumbers">
              <button>
                <p className="numbold">1</p>
              </button>
              <button>
                <p className="num">2</p>
              </button>
